...
def render_status_summary():
    ...
    readiness = "YES" if metrics.get("dq_total", 0) == metrics.get("dq_passed", 0) and metrics.get("recon_total", 0) == metrics.get("recon_passed", 0) else "REVIEW"
...
def render_reconciliation_dashboard():
    ...
    if df_recon.empty:
        ...
        recon_data = {
            ...
            'Status': ['PASS', 'PASS', 'REVIEW', 'PASS', 'PASS', 'PASS'],
...
st.subheader("Execution Audit Trail")
    ...
    if df_audit.empty:
        ...
        audit_data = {
            ...
            'Passed': [23, 17, 23, 18],
            'Failed': [0, 1, 0, 0],
            'Status': ['SUCCESS', 'PARTIAL', 'SUCCESS', 'SUCCESS']
        }
